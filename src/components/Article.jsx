            ...
            {isLoading ? <LoadingSpinner /> :
                <div className='col-md-12'>
                    ...
                    <article className='blog-post'>
                        ...
                        <p className='blog-post-meta mx-3'>{extractDate(articleObj.created_at)} by {toTitleCase(articleObj.author)}
                        </p>
                        <div className='blog-post-meta mx-3 text-end'>Was interesting for : {currVotes + articleObj.votes}</div>
                        <hr />
